...
import Api from '../api';
import { FETCH_CATEGORIES_FAIL, FETCH_CATEGORIES_REQUEST, FETCH_CATEGORIES_SUCCESS } from './types';

function* fetchCategories() {
  try {
    const data: ReturnType<typeof Api.fetchCategories> = yield call(Api.fetchCategories);
